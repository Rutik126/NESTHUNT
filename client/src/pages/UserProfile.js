  ...
  useEffect(() => { 
    const fetchUserProfile = async () => {
      try {
        ...
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_BASEURL}/api/user/profile`, {
          headers: {
  ...
  const removeSavedProperty = async (propertyId) => {
    try {
      ...
      const response = await axios.delete(
        `${import.meta.env.VITE_BACKEND_BASEURL}/api/user/remove-saved-property`,
        {
            ...
            <img
              src={
                profile.profilePhoto
                  ? `${import.meta.env.VITE_BACKEND_BASEURL}/${profile.profilePhoto.replace(/\\/g, '/')}`
